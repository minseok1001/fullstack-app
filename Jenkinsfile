        ...
        stage('K8S Manifest Update') {
            steps {
                ...
                dir("gitOpsRepo")
                {
                    ...
                    url: 'https://github.com/minseok1001/fullstack-app-k8s-manifest.git'

                    sh "git config --global user.email 'minseok1001@naver.com'"
                    sh "git config --global user.name 'minseok1001'"
                    ...
                    withCredentials([gitUsernamePassword(credentialsId: githubCredential,
                        ...
                        sh "git remote set-url origin https://github.com/minseok1001/fullstack-app-k8s-manifest.git"
